...
import 'package:vrna_app_mobile/src/pages/filter/filterresult.widget.dart';
...
import 'package:vrna_app_mobile/src/widgets/app_header.dart';
...
class FilterResultPage extends StatefulWidget {
  ...
  const FilterResultPage({Key key, this.filter}) : super(key: key);

  @override
  _FilterResultState createState() => _FilterResultState();
}

class _FilterResultState extends State<FilterResultPage> with FilterResultWidget {
  FilterBloc bloc;
  ...
  void didChangeDependencies() {
    ...
    bloc.getFilteredMovies(context, widget.filter);
  }
    ...
    return Background(
        child: Loading(
            ...
            child: Scaffold(
              ...
              drawer: SearchMovie(),
              body: Container(child: filterResult(context, widget.filter,bloc.movieFilterResponse)))));
  }
}
