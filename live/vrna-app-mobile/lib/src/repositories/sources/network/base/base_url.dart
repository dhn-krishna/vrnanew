...
final rateMovie = base + "/content-service/movie/rating";
final search = base + "/orch-service/vrnaflow/search";
final searchSuggestion = base + "/content-service/movie/suggest";
final filterMovies = base + "/orch-service/vrnaflow/menu";
final addFav = base + "/watchlist-service/favorites/add";
final getFav = base + "/watchlist-service/favorites/";
