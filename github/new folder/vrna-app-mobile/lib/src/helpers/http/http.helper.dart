...
class HttpHelper {
  ...
  static Future<Dio> _getInstance() async {
    ...
    // test
    var username1 = "anand.v@vrnaplex.com";
    var macaddress1 = "00-AD-24-48-AC-F5";

    if (_client == null) _client = Dio();

    Map<String, dynamic> headers = {};
    if (username1 != null) headers['userName'] = '$username1';
    if (macaddress1 != null) headers['macAddress'] = '$macaddress1';
