...
class MovieDetailsWidget extends StatefulWidget {
  ...
  MovieDetailsWidget({this.bloc, this.details});
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: <Widget>[
          MovieBannerSlider(
              movie: details, bannerUrl: details?.moviebannerurl ?? ''),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Padding(
                                      ...
                                      children: [
                                        ...
                                        if (movie.genre != null &&
                                          ...
                                          Text(
                                              ...
                                              style: theme.movietype),
                                        SizedBox(height: 10.0),
                                        Text(
                                            "${movie.movielength} | ${movie.language} | ${movie.maturityrating}",
                                            style: theme.movietype),
                                        SizedBox(height: 30.0),
                                        Text("Total:₹${movie.ppmCost}",
