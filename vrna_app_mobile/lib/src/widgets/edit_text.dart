...
class EditText extends StatefulWidget {
  ...
  const EditText({Key key, this.autofocus,this.border, this.value, this.onChange, this.placeholder, this.keyboardType, this.password, this.dark, this.multiline, this.labelText, this.mask,this.prefixIcon}) : super(key: key);
            ...
            // controller: _controller,
              ...
              decoration: InputDecoration(
                prefixIcon: widget.prefixIcon != null
                  ...
                  enabledBorder:widget.border == true? OutlineInputBorder(
                  ...
                  labelStyle: TextStyle(
                      fontSize: dimens.fontEditText,
                      color: widget.dark == true ? colors.textColor: colors.textColor //cor da label
                  ),
                  border: widget.border == true?OutlineInputBorder(
                      borderSide: BorderSide(
                          color: colors.accentLightColor, //cor da label quando esta com focus
                          width: 0
                      )
                  ):UnderlineInputBorder(
                      borderSide: BorderSide(color: colors.accentLightColor),
                    ),
                  focusedBorder: widget.border == true?OutlineInputBorder(
                      borderSide: BorderSide(
